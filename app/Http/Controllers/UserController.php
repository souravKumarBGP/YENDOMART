    ...
    public function store(Request $request){
        ...
        if(count($email_exist) >= 1){
            ...
            $request->validate([
                ...
                "name.required" => "Full name is required. Please provide your full name.",
                "name.max" => "Your full name cannot exceed 100 characters. Please use a shorter name.",
                ...
                "password.max" => "Your password cannot exceed 100 characters. Please use a shorter password.",
