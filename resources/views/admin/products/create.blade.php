                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-lg-6">
                                            <div class="input_box pb-3">
                                                ...
                                                <input type="number" value="30" name="quantity" id="quantity" />
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="input_box pb-3">
                                                ...
                                                <textarea name="product_discreption" id="product_discreption" rows="20" style="width: 100%; text-align: left;">{ "Model": "Apple", "RAM": 80GB, }</textarea>
        ...
        $(document).ready(function(){
            ...
            $(".new_product_form").on("submit", function(event){
                ...
                if(quantity.value.trim() == ""){
                    ...
                    quantity.focus();
                    quantity.style.borderColor="var(--color-danger)";
                    quantity.nextElementSibling.style.display = "block";
                    quantity.nextElementSibling.innerText = "Please total quantity."
                    return false;
                }else if(quantity.value.trim() > 500000){

                    quantity.focus();
                    quantity.style.borderColor="var(--color-danger)";
                    quantity.nextElementSibling.style.display = "block";
                    quantity.nextElementSibling.innerText = "Quantity must be less then Rs 500000."
                    return false;
                }else{

                    quantity.style.borderColor="var(--shadow-color)";
